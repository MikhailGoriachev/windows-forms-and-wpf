namespace TableFunctions.Models
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.использованиеИсточникаДанныхToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            this.использованиеИсточникаДанныхToolStripMenuItem});
            ...
            // 
            // использованиеИсточникаДанныхToolStripMenuItem
            // 
            this.использованиеИсточникаДанныхToolStripMenuItem.Name = "использованиеИсточникаДанныхToolStripMenuItem";
            this.использованиеИсточникаДанныхToolStripMenuItem.Size = new System.Drawing.Size(353, 22);
            this.использованиеИсточникаДанныхToolStripMenuItem.Text = "Использование источника данных";
            this.использованиеИсточникаДанныхToolStripMenuItem.Click += new System.EventHandler(this.DataSource_Command);
            // 
            // mniHelp
            // 
            ...
            this.Text = "Занятие 09.12.2021 и 13.12.2021 - демонстрация DataGridView: Таблица тригонометри" +
    "ческих функций, привязка данных";
        ...
        private System.Windows.Forms.ToolStripMenuItem использованиеИсточникаДанныхToolStripMenuItem;
    }
}
