...
namespace HomeWorkWF.Models
{
    // Класс Усеченный конус
    internal class Conoid : IFigure
    {
        // высота
        ...
        public (double top, double down) Radius {  
            ...
            set => (_radiusTop, _radiusDown) = (value.down > 0d && value.top > 0d) ? value : 
                throw new Exception("Значение должно быть больше 0!"); 
        }
        ...
        public double Density
        {
            ...
            set => _density = value > 0d
                ? value : throw new Exception("Значение должно быть больше 0!");
        }
