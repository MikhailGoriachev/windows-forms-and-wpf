...
namespace WpfFigure.Utilities
{
    ...
    internal class Utils
    {
        ...
        // формирование Uri изображения 
        public static ImageSource GetUri(string fileName)
        {
        ...
        // получение названия изображения файла и плотности материала по названию
        public static (string file, double density) GetMaterial(string material)
        {
            switch (material)
            {
                case "Сталь (нержавеющая)":
                    return ("steel.jpg", 7700d);
                case "Медь":
                    return ("copper.jpg", 8933d);
                case "Водяной лёд":
                    return ("ice.jpg", 916d);
                case "Гранит":
                    return ("granit.jpg", 2700d);
                default:
                    return ("", 0d);
            }
        }
