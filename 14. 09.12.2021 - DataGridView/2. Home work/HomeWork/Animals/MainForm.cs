...
namespace Animals
{
    public partial class MainForm : Form
    {
        ...
        {
            // вывод коллекции животных в DgvMain
            _controller.ShowDataGridView(DgvMain);
        ...
        private void OpenFile_Command(object sender, EventArgs e)
        {
            ...
            if (!_controller.LoadToFile(file, DgvMain)) {
        ...
        private void MainForm_DragEnter(object sender, DragEventArgs e)
        {
            ...
            // изменение цвета DataGridView и TreeView на главной форме
            DgvMain.RowsDefaultCellStyle.BackColor =
                DgvMain.BackgroundColor =
                TviMain.BackColor =
                DgvMain.GridColor = Color.CornflowerBlue;

            DgvMain.AlternatingRowsDefaultCellStyle.BackColor = Color.RoyalBlue;

        } // MainForm_DragEnter


        // DragDrop над формой
        private void MainForm_DragDrop(object sender, DragEventArgs e) => DragLeave_Command(sender, e);
        ...
        private void DragLeave_Command(object sender, EventArgs e)
        {
            ...
            DgvMain.RowsDefaultCellStyle.BackColor =
                DgvMain.BackgroundColor =
                TviMain.BackColor =
                DgvMain.GridColor = Color.Silver;

            DgvMain.RowsDefaultCellStyle.BackColor = Color.Gainsboro;
            DgvMain.AlternatingRowsDefaultCellStyle.BackColor = Color.Silver;
        } // DragLeave_Command
        ...
        private void DgvMain_DragEnter(object sender, DragEventArgs e)
        {
            ...
            // изменение цвета DataGridView на главной форме
            DgvMain.RowsDefaultCellStyle.BackColor =
                DgvMain.BackgroundColor = 
                DgvMain.GridColor = Color.SpringGreen;

            DgvMain.AlternatingRowsDefaultCellStyle.BackColor = Color.MediumSeaGreen;
        ...
        private void TviMain_DragEnter(object sender, DragEventArgs e)
        {
            // установка действия 
            e.Effect = e.Data.GetDataPresent(DataFormats.FileDrop) ? DragDropEffects.Copy : DragDropEffects.None;

            // изменение цвета DataGridView на главной форме
            TviMain.BackColor = Color.SpringGreen;

        } // DgvMain_DragEnter


        // DragDrop над TreeView
        private void TviMain_DragDrop(object sender, DragEventArgs e)
        {
            // проверка на тип содержания
            if (!e.Data.GetDataPresent(DataFormats.FileDrop))
                return;
        ...
        {
            _controller.ShowDataGridView(DgvSelected, _controller.SelectionWhereOwner(TbxSearch.Text));
        ...
        private void AddRange_Command(object sender, EventArgs e)
        {
            ...
            // обновление инфорайции в DataGridView
            _controller.ShowDataGridView(DgvMain, _controller.AnimalsZoo);
        ...
        private void EditElem_Command(object sender, EventArgs e)
        {
            ...
            // изменение элемента в DataGridView
            _controller.ShowDataGridViewChangeElem(DgvMain, _controller.AnimalsZoo, index);
        ...
        // выбор элемента в DataGridView (по любой клавише мыши)
        ...
        public void OrderBy()
        {
            ...
            else
            {
                ...
                switch (_order)
                {
                    // по возрасту 
                    case OrderType.Age:
                        _controller.ShowDataGridView(DgvOrdered, _controller.OrderByAge());
                        break;
                    // по виду
                    case OrderType.Specials:
                        _controller.ShowDataGridView(DgvOrdered, _controller.OrderBySpecials());
                        break;
                    // по фамилии владельца
                    case OrderType.Owner:
                        _controller.ShowDataGridView(DgvOrdered, _controller.OrderByOwner());
                        break;
                } // OrderBy
            }
        }
            ...
            else
            {
                ...
                switch (_selection)
                {
                    ...
                    case SelectionType.MaxWeight:
                        ...
                        if (GbxAnimalsSelected.Location != GbxSelectionSearch.Location)
                        {
                            GbxAnimalsSelected.Location =
                                new Point(GbxSelectionSearch.Location.X, GbxSelectionSearch.Location.Y);
                            GbxAnimalsSelected.Height += GbxSelectionSearch.Height;
                        }
                        ...
                        // выборка и вывод
                        _controller.ShowDataGridView(DgvSelected, _controller.SelectionWhereWeight());
                    ...
                    case SelectionType.OwnerSurnameSubString:
                        ...
                        // выборка и вывод
                        _controller.ShowDataGridView(DgvSelected, _controller.SelectionWhereOwner(""));
