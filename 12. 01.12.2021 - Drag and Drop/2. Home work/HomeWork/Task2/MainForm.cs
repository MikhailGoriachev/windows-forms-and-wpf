...
namespace Animals
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            // установка значений по умолчанию в информационном блоке
            SetDefaultInfoElem();
        } // MainForm_Load
        ...
        private void AddRange_Command(object sender, EventArgs e)
        {
            ...
            _controller.ShowListView(LvwAnimals, _controller.Animals);
        ...
        private void EditElem_Command(object sender, EventArgs e)
        {
            ...
            // форма для редактирования 
            AnimalForm animalForm = new AnimalForm(_controller.Animals[index]);
            ...
            // вывод измененного элемента
            LvwAnimals.Items[index] = _controller.Animals[index].GetListViewItem();
        }
        ...
        private void LvwAnimals_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            // выбранный элемент
            Animal animal = _controller.Animals[LvwAnimals.SelectedIndices[0]];

            // вывод информации о животном
            TbxCurrentSpecials.Text = animal.Specials;
            TbxCurrentName.Text     = animal.Name;
            TbxCurrentOwner.Text    = animal.Owner;
            TbxCurrentColor.Text    = animal.Сolor;
            TbxCurrentAge.Text      = animal.Age.ToString();
            TbxCurrentWeight.Text   = $"{animal.Weight:n5}";
        }
        ...
        // установка значений по умолчанию в информационном блоке
        public void SetDefaultInfoElem()
        {
            // вывод значений
            TbxCurrentSpecials.Text = "────────────────";
            TbxCurrentName.Text     = "────────────────";
            TbxCurrentOwner.Text    = "────────────────";
            TbxCurrentColor.Text    = "────────────────";
            TbxCurrentAge.Text      = "────────────────";
            TbxCurrentWeight.Text   = "────────────────";
        }
